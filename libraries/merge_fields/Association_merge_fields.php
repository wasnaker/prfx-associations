...
class Association_merge_fields extends App_merge_fields
{
    public function build()
    {
        return [
                ...
                [
                    'name'      => 'Association Files Admin Link',
                    'key'       => '{association_profile_files_admin_link}',
                    'available' => [

                    ],
                    'templates' => [
                        'new-association-profile-file-uploaded-to-staff',
                    ],
                ],
                [
                    'name'      => 'Client Website',
    ...
    /**
     * Merge fields for Contacts and Associations
    ...
    public function format($client_id, $contact_id = '', $password = '')
    {
        ...
        $fields['{association_profile_files_admin_link}'] = '';
        ...
        $fields['{association_profile_files_admin_link}'] = admin_url('clients/client/' . $client->userid . '?group=attachments');
        ...
        $custom_fields = get_custom_fields('associations');
        foreach ($custom_fields as $field) {
            $fields['{' . $field['slug'] . '}'] = get_custom_field_value($client_id, $field['id'], 'associations');
        }
