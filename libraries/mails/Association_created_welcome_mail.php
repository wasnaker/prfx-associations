...
class Association_created_welcome_mail extends App_mail_template
{
    ...
    public function build()
    {
        ...
        ->set_merge_fields('association_merge_fields', $this->client_id, $this->contact_id, $this->password);
    }
}
